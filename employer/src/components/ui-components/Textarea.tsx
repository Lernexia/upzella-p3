...
import { TextareaProps } from "@/types/props/TextareaProps.types";
...
const Textarea = forwardRef<HTMLTextAreaElement, TextareaProps>(
  (
    ...
    // Update hasValue and charCount when controlled value changes
    useEffect(() => {
    ...
    // Get resize class based on resize prop
    ...
    // Enhanced textarea classes with modern styling and animations
    const baseTextareaClasses = variant === 'floating'
        ...
        <label
          ...
          className={cn(
            ...
            isFloating
              ...
              : `top-6 -translate-y-1/2 text-sm scale-100 ${
    ...
    // Enhanced validation icon with modern styling (positioned at top-right)
    ...
    const CharacterCount = () => {
      ...
      return (
        <div className={cn(
          "mt-2 text-xs font-medium text-right",
