      ...
      <div className="sizer">
        <div className="text-center mb-16 pt-16">
          ...
          <p className="font-title text-xl text-gray-700 mb-6">
            Alerts, notifications, and feedback patterns
          </p>
        </div>
        ...
        <div className="pb-16">
          ...
          {/* Inline Messages */}
          <section className="mb-16">
            <h2 className="font-heading text-2xl font-bold text-gray-800 mb-6">Inline Messages</h2>
            
            <div className="grid md:grid-2 gap-6">
              <div className="card">
                <h3 className="font-title text-lg font-semibold text-gray-800 mb-4">Success Messages</h3>
                <div className="space-y-4">
                  <div className="flex items-center gap-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                    <CheckIcon size={16} className="text-green-600" />
                    <span className="font-body text-green-700 text-sm">Changes saved successfully</span>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                    <CheckIcon size={16} className="text-green-600" />
                    <span className="font-body text-green-700 text-sm">Job posted successfully</span>
                  </div>
                </div>
              </div>

              <div className="card">
                <h3 className="font-title text-lg font-semibold text-gray-800 mb-4">Error Messages</h3>
                <div className="space-y-4">
                  <div className="flex items-center gap-3 p-3 bg-red-50 border border-red-200 rounded-lg">
                    <XIcon size={16} className="text-red-600" />
                    <span className="font-body text-red-700 text-sm">Please fill in all required fields</span>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-red-50 border border-red-200 rounded-lg">
                    <XIcon size={16} className="text-red-600" />
                    <span className="font-body text-red-700 text-sm">Invalid email format</span>
                  </div>
                </div>
              </div>
            </div>
