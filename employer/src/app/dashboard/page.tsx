        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm p-0">
                ...
                <div className="divide-y divide-purple-200/30 overflow-y-scroll max-h-[400px]">
                  {loadingJobs ? (
                    <div className="p-8 text-center">
                      <InlineLoader variant='dots' color='purple' text="Loading jobs..." />
                    </div>
                  ) : recentJobs.length === 0 ? (
                    <div className="p-8 text-center">
                              ...
                              <div className="flex items-center space-x-2">
                                {job.employment_type ? (
                                  job.employment_type.map((type) => (
                                    <Badge key={type} variant="primary" size="sm" className="bg-gradient-to-r from-blue-500 to-blue-600 text-white">
                                      <span className="text-xs">{type}</span>
                                    </Badge>
                                  ))
                                ) : (<></>)}
                                <span className="text-sm text-gray-500 font-inter">
                                  {job.experience_details.experience_min}-{job.experience_details.experience_max} years
                                </span>
                                <span className="text-sm text-gray-500 font-inter">
